...
interface Find<Model, Select, Include, Input, UniqueInput, ScalarFieldEnum>
  extends FindMany<
  Model,
  Select,
  Include,
...
interface CountArgs<Model, Select, Include, Input, UniqueInput, ScalarFieldEnum, 
CountAggregate> extends Omit<FindMany<
  Model,
  Select,
  Include,
  Input,
...
export type Delegate<
  ...
  > = {
    findUnique: (
      args: FindUnique<Model, Select, Include, UniqueInput>
    ) => Promise<Model | null>;
    findFirst: (
      args: Find<Model, Select, Include, Input, UniqueInput, ScalarFieldEnum>
    ) => Promise<Model | null>;
    findMany: (
      args: FindMany<Model, Select, Include, Input, UniqueInput, ScalarFieldEnum>
    ) => Promise<Model[]>;
    ...
    update: (
      args: UpdateArgs<Select, Include, UniqueInput, UpdateInput>
    ) => Promise<Model>;
    ...
    upsert: (
      args: UpsertArgs<Select, Include, UniqueInput, CreateInput, UpdateInput>
    ) => Promise<Model>;
